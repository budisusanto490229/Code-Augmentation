...
class WGAN():
    ...
    def __init__(self):
        ...
        optimizer = RMSProp(lr=0.0005)  # 0.00005
...
if __name__ == '__main__':
    ...
    for num in range(0, 1000, 1):
        ...
        for i in range(len(gen_data[0])):
            ...
            if i == 0:
                open('Neutral/' + str(num) + 'neutral.txt', 'w').write(store_data)
            else:
                store_data = '\n' + store_data
                open('Neutral/' + str(num) + 'neutral.txt', 'a').write(store_data)
    ...
    for num in range(0, 500, 1):
        ...
        for i in range(len(gen_data[0])):
            ...
            for a in range(len(gen_data[0][i])):
                store_data += str(gen_data[0][i][a]) + ','
            if i == 0:
                open('Readable/' + str(num) + 'readable.txt', 'w').write(store_data)
            else:
                store_data = '\n' + store_data
                open('Readable/' + str(num) + 'readable.txt', 'a').write(store_data)
    ...
    for num in range(0, 500, 1):
        ...
        for i in range(len(gen_data[0])):
            ...
            for a in range(len(gen_data[0][i])):
                store_data += str(gen_data[0][i][a]) + ','
            if i == 0:
                open('Unreadable/' + str(num) + 'unreadable.txt', 'w').write(store_data)
            else:
                store_data = '\n' + store_data
                open('Unreadable/' + str(num) + 'unreadable.txt', 'a').write(store_data)
